            ...
            <div className='sticky top-0 z-40 bg-white border-b border-zinc-200'>
                ...
                <div className='max-w-7xl mx-auto px-6 h-16 flex items-center justify-between'>
                    <div className='text-lg font-semibold cursor-pointer' onClick={() => router.push('/')}>
                        Bot<span className='text-zinc-400'>Assist</span>
                    </div>
            ...
            <div className='flex justify-center px-4 py-14'>
                <motion.div
                    ...
                    <div className='relative bg-zinc-900 text-zinc-100 rounded-xl p-5 text-sm font-mono mb-10'>
                        <pre>{embedCode}</pre>
                        <button
                            className='absolute top-3 right-3 bg-white text-zinc-900 text-xs font-medium
                        px-3 py-1.5 rounded-lg hover:bg-zinc-200 transition cursor-pointer'
                            onClick={copyCode}>
                            {copied ? "Copied ✓" : "Copy"}
                        </button>
                    </div>
